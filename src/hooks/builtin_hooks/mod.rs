...
//!
//! These hooks automatically collect and attach debugging information on report creation:
//!
...
//! ## Report Formatter
//!
//! By default we install the [`DefaultReportFormatter`] as the report formatting
//! hook.
//!
...
//! formatter by implementing the [`ReportFormatterHook`] trait and then registering
//! it via [`register_report_formatter_hook`].
//!
